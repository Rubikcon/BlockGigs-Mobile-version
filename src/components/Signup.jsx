    ...
    <div className='w-full h-screen bg-[#0a0f29] flex flex-col items-center'>
      ...
      <form
        ...
        <div className='text-center'>
          ...
          <p className='text-[#676767] text-sm md:text-base text-nowrap'>Create an account with us by email or wallet</p>
        </div>
        ...
        <div className='flex justify-center items-center mt-6 space-x-2'>
          <p className='text-sm md:text-base text-[#292929]'>Already have an account?</p>
          <Link className='text-sm md:text-base text-[#177f9f]' to="/Signin">Sign in</Link>
        </div>
      </form>
    </div>
  );
