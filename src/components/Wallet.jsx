    ...
    <div className="w-full h-screen bg-[#0a0f29] flex flex-col items-center">
      ...
      <div className="flex flex-col w-[90%] max-w-[400px] px-6 py-8 md:p-10 items-center rounded-lg bg-white mt-8 md:mt-12 space-y-12">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-[#292929] text-xl md:text-2xl font-medium">Wallet Connection</h2>
          <p className="text-[#676767] tracking-[0.07px] text-[14px] font-onest leading-5">
            By signing up/connecting wallet, you agree to our 
            <span className="text-[#177f9f] leading-5 text-[14px] tracking-[0.07px]"> Terms & Conditions </span>
            and 
            <span className="text-[#177f9f] leading-5 text-[14px] tracking-[0.07px]"> Privacy Policy</span>.
          </p>
        </div>
        ...
        <Link to='/Code' className="flex w-full max-w-[350px] p-[12px] px-[32px] justify-center items-center gap-[12px] rounded-[8px] bg-[#177F9F] text-white font-onest text-base not-italic font-medium leading-6">
          Approve Connection
        </Link>
