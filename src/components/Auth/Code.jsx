...
const Code = () => {
  ...
  const handleSubmit = () => {
    ...
    if (enteredOtp === "123456") {
      // Replace '123456' with backend logic. this is temporary.
      setLoading(true);
      setTimeout(() => {
        setLoading(false);
      ...
      <div className="flex flex-col w-[90%] max-w-[400px] px-6 py-8 md:p-10 items-center rounded-lg bg-white mt-8 md:mt-12 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[#676767] tracking-[0.07px] text-[14px] font-onest leading-5">
            Enter the OTP code we just sent to your registered email address to
            reset your password.
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="font-poppins text-[#303030] text-xs font-normal leading-[18px]">
            Code sent will expire in{" "}
            <span className="text-[#ff4f4f]">10 minutes</span>.
          </p>
        </div>
