...
const Recommended = () => {
    ...
    const jobs = [
        {
            id: 1, title: "Frontend Developer Needed", description: "Looking for a frontend developer to work on various UI/UX projects...", posted: "Jacob", amount: "$5000/3 milestones", skills:
                "Javascript, MongoDB, Node js"
        },
        {
            id: 2, title: "Backend Developer for E-commerce", description: "Need an experienced backend developer to build scalable systems...", posted: "Sophia", amount: "$8000/4 milestones", skills:
                "Javascript, MongoDB, Node js"
        },
    ];
